...
/**
 * See {@code DeprecatedParquetInputFormat}
 */
public class MapredParquetInputFormat extends org.apache.hadoop.mapred.FileInputFormat<Void, VoidPointable> {
    ...
    private static class RecordReaderWrapper implements RecordReader<Void, VoidPointable> {
        ...
        private ParquetRecordReader<IValueReference> realReader;
        private long splitLen; // for getPos()

        /**
         * Value clazz is needed by Asterix during the creation of {@code HDFSDataSourceFactory}
         */
        private VoidPointable valueContainer = new VoidPointable();
