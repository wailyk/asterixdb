...
public class ObjectConverter extends AbstractComplexConverter {
    ...
    public ObjectConverter(AbstractComplexConverter parent, GroupType parquetType, ParserContext context) {
        super(parent, parquetType, context);
    }

    public ObjectConverter(AbstractComplexConverter parent, IValueReference fieldName, GroupType parquetType,
    ...
    public AtomicConverter createAtomicConverter(GroupType type, int index) {
        try {
            return new AtomicConverter(this, context.getSerializedFieldName(type.getFieldName(index)), context);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public ArrayConverter createArrayConverter(GroupType type, int index) {
        try {
            ...
            return new ArrayConverter(this, childFieldName, arrayType, context);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public ObjectConverter createObjectConverter(GroupType type, int index) {
        try {
            ...
            return new ObjectConverter(this, childFieldName, objectType, context);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
