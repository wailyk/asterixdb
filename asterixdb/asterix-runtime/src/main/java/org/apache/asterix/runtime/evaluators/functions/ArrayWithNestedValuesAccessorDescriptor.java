...
public class ArrayWithNestedValuesAccessorDescriptor extends AbstractScalarFunctionDynamicDescriptor {
    ...
    private AbstractCollectionType inputListType;
    private AbstractCollectionType outListType;
    ...
    public static final IFunctionDescriptorFactory FACTORY = new IFunctionDescriptorFactory() {
        ...
        public IFunctionTypeInferer createFunctionTypeInferer() {
            return new FunctionTypeInferers.ForEachTypeInferer();
        }
    };
    ...
    public void setImmutableStates(Object... states) {
        inputListType = (AbstractCollectionType) states[0];
        outListType = (AbstractCollectionType) TypeComputeUtils.getActualType((IAType) states[1]);
    }
    ...
    private class ArrayWithNestedValuesAccessorEval implements IScalarEvaluator {
        ...
        private final IScalarEvaluator nestedValueEval;
        ...
        public ArrayWithNestedValuesAccessorEval(IScalarEvaluatorFactory[] args, IEvaluatorContext ctx)
                throws HyracksDataException {
            outputListBuilder = new OrderedListBuilder();
            listEval = args[0].createScalarEvaluator(ctx);
            nestedValueEval = args[1].createScalarEvaluator(ctx);
            ...
            itemSelfDescribing = outListType.getItemType().getTypeTag() == ATypeTag.ANY;
        ...
        public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
            ...
            outputListBuilder.reset(outListType);
            for (int i = 0; i < accessor.size(); i++) {
                setItemValue(serArray, i);
                nestedValueEval.evaluate(itemValue, nestedValue);
